...
//    {
//        List<CollectTask_> pendingTasks = collectTaskService.getNeedCollectTask();
...
//    }
//
//    private boolean shouldExecute(CollectTask_ task)
//    {
...
//            TaskExecution_ lastExecution = taskExecutionService.getLastExecution(task.getId());
//
